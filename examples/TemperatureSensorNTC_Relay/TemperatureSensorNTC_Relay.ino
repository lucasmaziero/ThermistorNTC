/**************************************************************************
*       LEITURA DO SENSOR DE TEMPERATURA NTC E ACIONAMENTO DE UM RELAY                             
***************************************************************************
...
TAMANHO: 5,442 BYTES    MÁXIMO: 32,256 BYTES                           
***************************************************************************
...
void loop() 
{
  ...
  Serial.println("C"); //Imprime no serial
   ...
   if(tempNTC <= TempDesliga && TempAux==0)
  {
    digitalWrite(pinRelay,LOW);
  }

  if(tempNTC >= TempDesliga)
  {
    digitalWrite(pinRelay,HIGH);
    TempAux=1;
  }  
  if(tempNTC <= (TempDesliga-TempOffSet))
  {
    TempAux=0;
  }
